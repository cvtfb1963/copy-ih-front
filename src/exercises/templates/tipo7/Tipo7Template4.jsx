...
const template = {
  ...
  formulasPage: {
    toComplete: [
      ["Suj.", "Have / Has", "Been", "V.(ing)", "Complemento"],
      ["Suj.", "Have / Has", "Not", "Been", "V.(ing)", "Complemento"],
      ["(Wh_)", "Have / Has", "Suj.", "Been", "V.(ing)", "Complemento?"],
    ],
  ...
  return (
    <div className="gramatica-page">
      <div className="gramatica-container">
        <TitleRenderer />
        <FloatingVideo
          videoID={EXPLANATION_VIDEOS[7.4] ?? EXPLANATION_VIDEOS[7]}
          removeMarginBottom
        />
        {step < 2 ? (
