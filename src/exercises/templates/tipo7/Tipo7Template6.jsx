...
const template = {
  ...
  formulasPage: {
    toComplete: [
      ["Sujeto", "Was / Were", "V.(ing)", "Complemento"],
      ["Sujeto", "Was / Were", "Not", "V.(ing)", "Complemento"],
      ["(Wh_)", "Was / Were", "Sujeto", "V.(ing)", "Complemento?"],
    ],
  ...
  return (
    <div className="gramatica-page">
      <div className="gramatica-container">
        <TitleRenderer />
        <FloatingVideo
          videoID={EXPLANATION_VIDEOS[7.6] ?? EXPLANATION_VIDEOS[7]}
          removeMarginBottom
        />
        {step < 2 ? (
