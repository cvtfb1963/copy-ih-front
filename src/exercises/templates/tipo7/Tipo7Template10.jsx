...
const template = {
  ...
  formulasPage: {
    toComplete: [
      ["Sujeto", "Am / Are / Is", "Going to", "V.(inf)", "Complemento"],
      ["Sujeto", "Am / Are / Is", "Not", "Going to", "V.(inf)", "Complemento"],
      [
        "(Wh_)",
        "Am / Are / Is",
        "Sujeto",
  ...
  return (
    <div className="gramatica-page">
      <div className="gramatica-container">
        <TitleRenderer />
        <FloatingVideo
          videoID={EXPLANATION_VIDEOS["7.10"] ?? EXPLANATION_VIDEOS[7]}
          removeMarginBottom
        />
        {step < 2 ? (
