...
const template = {
  ...
  center: {
    ...
    verboTotal: {
      left: "Will",
      right: ["Have", "Past Part."],
      options: pantalla1options,
    },
  },
  formulasPage: {
    toComplete: [
      ["Suj.", "Will", "Have", "V.(Past Part.)", "Complemento"],
      ["Suj.", "Will", "Not", "Have", "V.(Past Part.)", "Complemento"],
      ["(Wh_)", "Will", "Suj.", "Have", "V.(Past Part.)", "Complemento?"],
    ],
  ...
  return (
    <div className="gramatica-page">
      <div className="gramatica-container">
        <TitleRenderer />
        <FloatingVideo
          videoID={EXPLANATION_VIDEOS["7.13"] ?? EXPLANATION_VIDEOS[7]}
          removeMarginBottom
        />
        {step < 2 ? (
