...
const template = {
  ...
  center: {
    ...
    initialGrades: [0, 0, 0, 0, 0, 0, 0, 0, 0],
    piramides: {
      1: "Will",
      2: "Inf.",
      3: "Have",
    ...
    verboTotal: {
      left: "Will",
      right: ["Have", "Been", "V.(ing)"],
      options: pantalla1options,
    },
  },
  formulasPage: {
    toComplete: [
      ["Suj.", "Will", "Have", "Been", "V.(ing)", "Complemento"],
      ["Suj.", "Will", "Not", "Have", "Been", "V.(ing)", "Complemento"],
      ["(Wh_)", "Will", "Suj.", "Have", "Been", "V.(ing)", "Complemento?"],
    ],
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          small: true,
          options: template.center.options,
          response: template.center.piramides[8],
          onGradeChange: (v) => handleCenterChange(7, v),
        },
      },
    ],
    links: [
  ...
  return (
    <div className="gramatica-page">
      <div className="gramatica-container">
        <TitleRenderer />
        <FloatingVideo
          videoID={EXPLANATION_VIDEOS["7.14"] ?? EXPLANATION_VIDEOS[7]}
          removeMarginBottom
        />
        {step < 2 ? (
