...
const template = {
  ...
  template: 1,
  center: ["Present", "Do / Does", "Verbo (infinitivo)", "Verbo (present)"],
  top: [
    "Aux: Do / Does",
    "Verbo Restante: Verbo (infinitivo)",
    "Verbo total: Verbo (presente)",
  ],
  formulasPage: {
    toComplete: [
      ["Sujeto", "Verbo (Present)", "Complemento"],
      ["Sujeto", "Do / Does", "Not", "Verbo (Inf.)", "Complemento"],
      ["(Wh_)", "Do / Does", "Sujeto", "Verbo (Inf.)", "Complemento?"],
    ],
  ...
  return (
    <div className="gramatica-page">
      <div className="gramatica-container">
        <TitleRenderer />
        <FloatingVideo
          videoID={EXPLANATION_VIDEOS[7.1] ?? EXPLANATION_VIDEOS[7]}
          removeMarginBottom
        />
        {step < 2 ? (
          <div className="et7-container">
            ...
            >
              <div style={{ display: "flex" }}>
                ...
                >
                  <h1 style={{ color: TIPO7_RED }}>PRESENT</h1>
                  <div
                    style={{
                      width: "1px",
                      height: "50px",
