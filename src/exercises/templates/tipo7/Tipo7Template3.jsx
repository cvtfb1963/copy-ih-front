...
const template = {
  ...
  formulasPage: {
    toComplete: [
      ["Suj.", "Have / Has", "V.(Past Part.)", "Complemento"],
      ["Suj.", "Have / Has", "Not", "V.(Past Part.)", "Complemento"],
      ["(Wh_)", "Have / Has", "Suj.", "V.(Past Part.)", "Complemento?"],
    ],
  ...
  return (
    <div className="gramatica-page">
      <div className="gramatica-container">
        <TitleRenderer />
        <FloatingVideo
          videoID={EXPLANATION_VIDEOS[7.3] ?? EXPLANATION_VIDEOS[7]}
          removeMarginBottom
        />
        {step < 2 ? (
